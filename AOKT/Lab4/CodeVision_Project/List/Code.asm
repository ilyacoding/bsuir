...
_adc_isr:
	...
	IN   R30,SREG
	ST   -Y,R30
; 0000 0021     unsigned char al, ah;
; 0000 0022     unsigned short tenBitValue;
; 0000 0023     al = ADCL;
	CALL __SAVELOCR4
;	al -> R17
;	ah -> R16
...
; 0000 0024     ah = ADCH;
	IN   R16,5
; 0000 0025     // ADLAR == 1
; 0000 0026     tenBitValue = (ah << 2) | (al >> 6);
	MOV  R30,R16
	LDI  R31,0
	CALL __LSLW2
	MOVW R22,R30
	...
	OR   R31,R23
	MOVW R18,R30
; 0000 0027     PORTC = tenBitValue;
	OUT  0x15,R18
; 0000 0028     ADCSRA = 0xEC;
	LDI  R30,LOW(236)
	OUT  0x6,R30
; 0000 0029 }
	CALL __LOADLOCR4
...
; 0000 008D ADMUX=0x61;
	LDI  R30,LOW(97)
	OUT  0x7,R30
; 0000 008E ADCSRA=0xEC;
	LDI  R30,LOW(236)
	OUT  0x6,R30
; 0000 008F 
; 0000 0090 // Set ADCSR
; 0000 0091 //ADCSR = 0xE8;
; 0000 0092 
