...
namespace CrudWebApi.Controllers
{
    ...
    builder.EntitySet<Review>("ReviewSet"); 
    config.Routes.MapODataServiceRoute("odata", "odata", builder.GetEdmModel());
    */
    public class UsersController : ODataController
    {
        private BlogContextEntities db = new BlogContextEntities();
        ...
        // GET: odata/Users(5)/Reviews
        [EnableQuery]
        public IQueryable<Review> GetReviews([FromODataUri] int key)
        {
            return db.UserSet.Where(m => m.Id == key).SelectMany(m => m.Reviews);
        }
